...
public class StudentCURDTest extends TestBase {
  ...
  static String firstName = "akshit"+ TestUtils.getRandomValue(); //akshit45945
  static String lastName = "patel"+ TestUtils.getRandomValue(); //akshit456
  static String email = "aki"+ TestUtils.getRandomValue()+ "@gmail.com"; //akshit456@gmail.com
